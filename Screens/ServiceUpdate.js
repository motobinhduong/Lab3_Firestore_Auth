...
const ServiceUpdate = ({ route, navigation }) => {
    ...
    return (
        <View style={{ padding: 10 }}>
            ...
            <Button style={{margin: 20}} buttonColor="aqua" textColor="black" mode="contained" onPress={handleUploadImage}>Change Image</Button>
            ...
            />
            <Button buttonColor="aqua" textColor="black" mode="contained" onPress={handleUpdateService}>Update</Button>
        </View>
    );
}
