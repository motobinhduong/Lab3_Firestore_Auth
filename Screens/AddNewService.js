...
const AddNewService = ({navigation}) => {
    ...
    return (
        <View style={{ padding: 10 }}>
            ...
            <Button textColor="black" buttonColor="aqua" style={{margin: 10}} mode="contained" onPress={handleUploadImage}>
                Upload Image
            </Button>
            {((imagePath!= "")&&
            ...
            <TextInput
                ...
                style={{ marginBottom: 10, borderWidth: 1, borderColor: '#ccc' }}
            />
            <Button buttonColor="aqua" textColor="black" mode="contained" onPress={handleAddNewService}>Add</Button>
        </View>
    );
};
